...
const variantColorMap: Record<string, Record<string, string>> = {
  ...
  outlined: {
    neutral:
      "border-[hsl(var(--neutral-dark))] hover:bg-[hsl(var(--neutral-dark))] hover:border-[hsl(var(--neutral))] active:border-[hsl(var(--neutral-light))] active:bg-[hsl(var(--neutral))]",
    primary:
      "text-[hsl(var(--primary-light))] border-[hsl(var(--primary-dark))] hover:text-[hsl(var(--primary-foreground))] hover:bg-[hsl(var(--primary-dark))] hover:border-[hsl(var(--primary))] active:border-[hsl(var(--primary-light))] active:bg-[hsl(var(--primary))]",
    secondary:
      "text-[hsl(var(--secondary-light))] border-[hsl(var(--secondary-dark))] hover:text-[hsl(var(--secondary-foreground))] hover:bg-[hsl(var(--secondary-dark))] hover:border-[hsl(var(--secondary))] active:border-[hsl(var(--secondary-light))] active:bg-[hsl(var(--secondary))]",
    contrast:
      "border-[hsl(var(--foreground)/.7)] hover:bg-[hsl(var(--neutral-dark))] active:bg-[hsl(var(--neutral-light))]",
  },
  text: {
    neutral:
      "text-[hsl(var(--foreground-light))] hover:text-[hsl(var(--foreground))] hover:bg-[hsl(var(--neutral-dark))] hover:ring-[hsl(var(--neutral-dark))] active:bg-[hsl(var(--neutral))] active:ring-[hsl(var(--neutral))]",
    primary:
    ...
    secondary:
      "text-[hsl(var(--secondary-light))] hover:bg-[hsl(var(--secondary-light)/.15)] hover:ring-[hsl(var(--secondary-light)/.15)] active:bg-[hsl(var(--secondary-light)/.2)] active:ring-[hsl(var(--secondary-light)/.2)]",
    contrast:
      "text-[hsl(var(--primary-light))] hover:bg-[hsl(var(--primary-light)/.15)] hover:ring-[hsl(var(--primary-light)/.15)] active:bg-[hsl(var(--primary-light)/.2)] active:ring-[hsl(var(--primary-light)/.2)]",
  },
};
...
const buttonBase = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ghost: "",
