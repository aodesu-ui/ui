...
function DropdownMenuItem({
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        dropdownMenuItemVariants({ variant, inset, size }),
        className
      )}
      {...props}
    />
...
function DropdownMenuSubTrigger({
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      ...
      className={cn(dropdownMenuSubTriggerVariants({ inset, size }), className)}
      {...props}
    >
      {children}
...
// ===== Export =====
export {
  DropdownButton, DropdownMenu, DropdownMenuCheckboxItem, DropdownMenuContent, dropdownMenuContentVariants, DropdownMenuGroup, DropdownMenuItem, dropdownMenuItemVariants, DropdownMenuLabel, DropdownMenuRadioGroup,
  DropdownMenuRadioItem, DropdownMenuSeparator,
  DropdownMenuShortcut, DropdownMenuSub, DropdownMenuSubContent, DropdownMenuSubTrigger, dropdownMenuSubTriggerVariants, DropdownMenuTrigger
};
